...
const catCards = [
  ...
  { id: 'reusable-badges',label: 'Reusable Badges',  sub: 'Write-on, wipe-off & insert',    bg: '#1A2E2A' },
  { id: 'button-badges',  label: 'Button Badges',     sub: 'Full-colour pin-back badges',    bg: '#2C2A3A' },
  { id: 'corporate-gifts',label: 'Keyrings & Gifts',  sub: 'Classic, resin, wood & bespoke', bg: '#1A1A1A' },
  { id: 'stickers',       label: 'Stickers & Labels', sub: 'Domed, vinyl & self-adhesive',   bg: '#2A1A2A' },
  { id: 'signs',          label: 'Signs & Nameplates', sub: 'Door signs, desk plates & more', bg: '#1A2A1A' },
];
...
const features = [
  ...
  { icon: '✉️', title: 'Easy Ordering', desc: 'Send us your logo and we handle the rest. No design experience needed.' },
];
